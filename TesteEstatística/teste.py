...
axis[0,1].plot(dataDelta) 
# axis[ 0].plot(dataDelta) 
# axis[ 1].plot(dataTheta) 
# axis[ 2].plot(dataAlpha) 
# axis[ 3].plot(dataBeta) 

# df = pd.DataFrame(dataDelta)
# df = pd.DataFrame(dataTheta)
# df = pd.DataFrame(dataAlpha)
# df = pd.DataFrame(dataBeta)
...
# Criando o gráfico de boxplot para as quatro colunas
plt.figure(figsize=(10, 6))
sns.boxplot(data=axis)
plt.title('Boxplot das colunas BL01, BL02, BL03, BL04')
plt.xlabel('Colunas')
plt.ylabel('Valores')
plt.show()