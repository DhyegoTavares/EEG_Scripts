clear all;
Nome='';
pastaDados= 'C:\Users\dhyeg\OneDrive\Dhyego\Mestrado\Matlab\Scripts\EDF_Rose\SET\netlab\';
pastaReport= 'C:\Users\dhyeg\OneDrive\Dhyego\Mestrado\Matlab\Scripts\EDF_Rose\SET\netlab\Relatorio\';
mkdir(pastaReport);
FreqMap = [3 11 22 34];
FreqRange = [2 40];
delChanels ={'Cz'};
...
for rt=1:length(ritmos)
    fp=fopen([pastaReport ritmos{rt} '.csv'],'wt');
