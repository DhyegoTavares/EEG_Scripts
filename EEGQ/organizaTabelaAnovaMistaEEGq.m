clear all
dirName=['C:\Users\dhyeg\OneDrive\Dhyego\Mestrado\Matlab\Scripts\EDF_Rose\MERGE\SET\netlab\Relatorio\Arquivos'];
...
for j=1:length(files)
    ...
    newName = [dirName '\' files(j).name(1:end-4) '_ANOVA.xls'];
    disp(newName);
